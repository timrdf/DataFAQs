#3> <> prov:specializationOf <https://github.com/timrdf/DataFAQs/raw/master/services/sadi/faqt/access/in-sparql-endpoint.py>;
...
# The Service itself
class InSPARQLEndpoint(faqt.Service):
