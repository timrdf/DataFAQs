...
class SizeDeprecated(faqt.Service):
   ...
   comment                = ''
   serviceNameText        = 'size-deprecated' # Convention: Match 'name' below.
   name                   = 'size-deprecated' # This value determines the service URI relative to http://localhost:9090/
