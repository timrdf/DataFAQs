#3> <> prov:specializationOf <https://github.com/timrdf/DataFAQs/raw/master/services/sadi/faqt/lodcloud/max-1-topic-tag.py>;
...
# The Service itself
class MaxOneTopicTag(faqt.Service):
   ...
   def __init__(self):
      faqt.Service.__init__(self, servicePath = 'services/sadi/faqt/lodcloud')
