...
class TripleCountAccuracy(sadi.Service):
   ...
   serviceDescriptionText = 'Measures accuracy of void:triples assertion compared to the triple count of the RDF found at void:dataDump.'
   comment                = ''
